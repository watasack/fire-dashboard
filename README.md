...
```
0〜5歳（未就学）  → young_child:  2,596,000円/年
6〜11歳（小学生） → elementary:   2,814,000円/年
12〜14歳（中学生）→ junior_high:  2,992,000円/年
15〜17歳（高校生）→ high_school:  3,139,000円/年
18〜21歳（大学生）→ university:   3,251,000円/年
22歳以降（独立後）→ empty_nest:   2,392,000円/年
```

カテゴリ別予算（23カテゴリ）から積み上げた値。日用品・携帯代を実態に合わせて調整済み。
...
2. **3段階警戒システム**
   ...
   レベル1（警戒）:   ドローダウン -10%〜-20%  → 裁量的支出20%削減
   レベル2（深刻）:   ドローダウン -20%〜-35%  → 裁量的支出50%削減
   レベル3（危機）:   ドローダウン -35%以下     → 裁量的支出70%削減
   ```
