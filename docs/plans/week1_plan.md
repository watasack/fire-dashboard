...
3. MC計算・グラフ表示・最悪ケース分析の動作確認
4. 入力ガイド・FAQをツール内に組み込み（サイドバー or ヘルプセクション）
5. Streamlit Cloud にフル版をデプロイ
6. ダミーデータ3パターンで動作確認
...
|------|---------|------|
| デモ URL | 公開済み | ✅ |
| フル版Webツール | アクセスコード認証・デプロイ完了 | ⬜ 未着手 |
| note 記事 | 有料記事として公開 | ⬜ タスクA完了後 |
...
- [ ] フル版Webツール完成（タスクA） → note 記事公開（タスクB）の順番で実施
- [ ] note 有料記事の価格設定：検討中
